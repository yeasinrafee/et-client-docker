...
export default function DemoCategoriesPage() {
  ...
  const { useGetItems, useCreateItem, useUpdateItem, useDeleteItem } = useCrud("demo-categories");
  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold">Manage Demo Categories</h1>
      </div>
      ...
      <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Create Demo Category</DialogTitle>
          </DialogHeader>
      ...
      <Dialog open={isEditOpen} onOpenChange={setIsEditOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Edit Demo Category</DialogTitle>
          </DialogHeader>
      ...
      <Dialog open={isViewOpen} onOpenChange={setIsViewOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>View Demo Category</DialogTitle>
          </DialogHeader>
          {selectedItem && (
