...
export default function DemosPage() {
  ...
  const [formData, setFormData] = useState({ title: "", slug: "", description: "", demoUrl: "" });
  ...
  const handleCreate = (e: React.FormEvent) => {
    ...
    createMutation.mutate(formData, {
      onSuccess: () => {
        ...
        setFormData({ title: "", slug: "", description: "", demoUrl: "" });
      },
    });
  };
  ...
  return (
    <div className="p-6">
            ...
            {isLoading ? (
              ...
              items.map((item: any) => (
                <TableRow key={item._id}>
                  ...
                  <TableCell>
                    {item.demoUrl && (
                      <a href={item.demoUrl} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">
                        Link
                      </a>
                    )}
                  </TableCell>
      ...
      <Dialog open={isViewOpen} onOpenChange={setIsViewOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>View Demo</DialogTitle>
          </DialogHeader>
          {selectedItem && (
            <div className="space-y-4 mt-4">
              ...
              {selectedItem.demoUrl && (
                <div>
                  <Label className="text-gray-500 text-sm">Demo URL</Label>
                  <div className="font-medium">
                    <a href={selectedItem.demoUrl} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">
                      {selectedItem.demoUrl}
                    </a>
                  </div>
                </div>
